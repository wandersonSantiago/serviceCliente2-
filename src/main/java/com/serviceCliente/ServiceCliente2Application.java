...
import com.serviceCliente.security.Perfil;
...
public class ServiceCliente2Application implements CommandLineRunner {
	...
	public void run(String... arg0) throws Exception {
		...
		/*
		 * est1.setCidades(Arrays.asList(c1)); est2.setCidades(Arrays.asList(c2,c3));
		 */
		...
		Endereco e1 = new Endereco(null, "rua teste", "4545", "teste complemento", "bairro teste", "45646545", cli1,
				c1);
		Endereco e2 = new Endereco(null, "rua teste", "4545", "teste complemento", "bairro teste", "45646545", cli1,
				c2);
